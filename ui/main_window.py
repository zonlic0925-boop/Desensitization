...
class MainWindow(QMainWindow):
    ...
    def _build_toolbar(self) -> QHBoxLayout:
        ...
        self._out_dir_label.setMaximumWidth(220)
        ...
        self._mode_erase = QRadioButton("真删除 (ERASE)")
        self._mode_cover = QRadioButton("黑块覆盖 (COVER)")
